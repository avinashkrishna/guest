...
setAddCart= new EventEmitter();
sendaddcartsubject= new Subject();
sendAddCart(value){
    this.addcartvalue= value;
}
getcartdetails(){
    return this.addcartvalue;
}
...
// console.log("dgffffffffffffffffffffffffffffffffff")
// this.getCartDetails();
//     }
//     cartDetailsfun(){
